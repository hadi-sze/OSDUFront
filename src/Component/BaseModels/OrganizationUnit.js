        ...
        <Stack spacing={3} alignItems={"flex-start"}>
          ...
          >
            ...
            >
              ...
              <Typography startDecorator={<InfoIcon />} sx={{ mb: 2 }} > REFERENCE ORG UNIT TYPE
                <Typography color="success" > The reference type of organization unit. For example: Area, Field, Business Associate. </Typography>
              </Typography>
            </Sheet>
            <br></br>
